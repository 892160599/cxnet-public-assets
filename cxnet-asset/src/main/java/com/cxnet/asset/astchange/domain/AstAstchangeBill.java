 ...
 */
@Data
@ApiModel(description = "资产变动主表")
public class AstAstchangeBill extends BaseEntity implements Serializable {
    private static final long serialVersionUID = 242711299876219723L;
    ...
    @ApiModelProperty("配置原值")
    private String ifCost;

    @ApiModelProperty("配置累计折旧")
    private String ifDepTotal;

    @ApiModelProperty("配置取得日期")
    private String ifAddDate;

    @ApiModelProperty("配置折旧方法")
    private String ifDepMethod;

    @ApiModelProperty("配置设计使用月份")
    private String ifUseLife;

    @ApiModelProperty("配置资产类别编码")
    private String ifCategoryCode;

    @ApiModelProperty("配置存放地点代码")
    private String ifPlaceCode;
