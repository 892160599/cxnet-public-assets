 ...
 *
 * @author caixx
 * @since 2021-04-09 14:04:33
 */
@Data
@ApiModel(description = "资产折旧明细表")
public class AstDeprList implements Serializable {
    private static final long serialVersionUID = -41780980109293342L;
    ...
    @TableField(exist = false)
    private List<AstDeprList> children;
