package com.cxnet.asset.dispose.domain;
 ...
 */
@Data
@ApiModel(description = "资产处置主表")
public class AstDisposeBill extends BaseEntity implements Serializable {
    private static final long serialVersionUID = -68501828987967630L;
    ...
    @ApiModelProperty("处置总额")
    private BigDecimal cost;

    @ApiModelProperty("处置数量")
    private Integer qty;

    @ApiModelProperty("处置形式代码")
