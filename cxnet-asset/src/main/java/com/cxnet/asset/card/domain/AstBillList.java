 ...
 */
@Data
@ApiModel(description = "资产操作明细表")
public class AstBillList extends BaseEntity implements Serializable {
    private static final long serialVersionUID = -58256514385472004L;
    ...
    @ApiModelProperty("卡片状态 1使用中,2已处置,3已调拨")
