...
public class MinioUtil {
     ...
     */
    @SneakyThrows(Exception.class)
    public void upload(String bucketName, String fileName, String filePath, PutObjectOptions options) {
        minioClient.putObject(bucketName, fileName, filePath, options);
    }
