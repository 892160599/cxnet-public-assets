package com.cxnet.project.system.message.mapper;
...
public interface MessageMapper {
     ...
     * @return 结果
     */
    public int updateMessageStatus(@Param("messageId") String messageId, @Param("type") String type, @Param("status") String status);
